...
namespace ComputersStore.BusinessServices.Interfaces
{
    public interface IApplicationUserBusinessService
    {
        ...
        Task<ApplicationUsersFilteredCollectionViewModel> GetApplicationUsersFilteredCollection(string roleName, string firstName, string lastName, string email, string phoneNumber, int pageNumber, int pageSize);
